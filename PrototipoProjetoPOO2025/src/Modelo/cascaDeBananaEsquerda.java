...
public class cascaDeBananaEsquerda extends Personagem{    
    
    private Personagem hero; 
    
    public cascaDeBananaEsquerda(String sNomeImagePNG, Personagem hero){
        super(sNomeImagePNG);
    ...
    public void autoDesenho(){
        ...
        if (linhaAtual == this.getPosicao().getLinha() && heroColuna == this.getPosicao().getColuna()){    
            hero.setPosicao(pPosicao.getLinha(), pPosicao.getColuna() - 4);
        }       
    }
